// mkcerts <dir> — generates a self-signed CA plus leaf certs for the relay
// and two gateways ("gw-A", "gw-B"), all signed by that CA. Leaf CN == the
// id used later as the QUIC-level gateway identifier.
use anyhow::Result;
use clap::Parser;
