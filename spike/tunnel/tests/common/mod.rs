// spike/tunnel/tests/common/mod.rs
//
// Canonical two-node WireGuard tunnel lab helper (Task 3 interface deliverable).
// Tasks 6-9 and 14 reuse this pattern by copy — each spike crate is standalone.
//
